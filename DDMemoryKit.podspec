...
Pod::Spec.new do |s|
  ...
  s.source_files = 'Code/DDMemoryKit.h'
  ...
  s.subspec 'core' do |ss|
    ss.source_files = 'Code/core/dd_memory_kit.h'
    ss.subspec 'macho' do |sss|
      sss.source_files = 'Code/core/macho/*.{h,c}'
      sss.public_header_files = 'Code/core/macho/*.h'
    end
  end
